...
import static ru.job4j.shortcut.config.JWTAuthenticationFilter.SIGN_UP_URL;
...
public class WebSecurity extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors().and().csrf().disable().authorizeRequests()
                ...
                .and()
                .addFilterBefore(
                        new JWTAuthenticationFilter("/login",
                                authenticationManager()), JWTAuthorizationFilter.class)
